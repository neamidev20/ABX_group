...
export default function HeroContent() {
    ...
    return (
        <section className="relative w-full flex flex-col items-center justify-center min-h-screen">
            <div className="flex z-10 w-full  md:w-[85%] 2xl:w-[65%]  flex-col text-white mt-10 px-6 sm:pl-20 md:px-0 items-center justify-center">
                <motion.h2
                    className=""
                ...
                >
                    ...
                    <br />
                    <span
                        className={`block mb-6 md:mb-12 text-2xl md:text-3xl lg:text-5xl 2xl:text-7xl tracking-wide  font-bold`}
                    >
                        {t("title.part_two")}
                    </span>
                </motion.h2>
                ...
                <Link
                    href="#about-us"
                    className="flex items-center justify-around  absolute bottom-10 md:bottom-12"
                >
                    <div className="relative w-[40px] h-[65px] md:w-[45px] md:h-[80px] border-[3px] border-gray-300 rounded-[60px]">
                        <div className="absolute top-[10px] left-1/2 w-[12px] h-[12px] bg-gray-50 rounded-full animate-wheel transform -translate-x-1/2"></div>
                    </div>
                </Link>
            </div>
